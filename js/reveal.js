...
var Reveal = (function(){
	...
	function loadSlide( slide ) {
		...
		toArray( slide.querySelectorAll( 'img[data-src], iframe[data-src], video[data-src], audio[data-src]' ) ).forEach( function( element ) {
	...
	function onDocumentKeyDown( event ) {
		...
		// EDITED LEEROY
		// Check if Magnific Popup is active
		var magnificPopupActive = document.getElementsByClassName("mfp-wrap").length !== 0;

		var hasFocus = !!( document.activeElement && ( magnificPopupActive || document.activeElement.type || document.activeElement.href || document.activeElement.contentEditable !== 'inherit' ) );
	...
	function onDocumentMouseScroll( event ) {
		...
		// EDITED LEEROY
		// Check for MFP
		if (document.getElementsByClassName("mfp-wrap").length !== 0) return;
