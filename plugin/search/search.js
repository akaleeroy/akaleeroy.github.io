...
function Hilitor(id, tag)
{
  ...
  this.hiliteWords = function(node)
  {
    ...
    // EDITED LEEROY
    if(node.nodeType == 3 || node.alt) { // NODE_TEXT or image nodes with attributes  
      if((nv = node.nodeValue) && (regs = matchRegex.exec(nv))) {
        ...
        // EDITED LEEROY
        match.style.fontWeight = "inherit";
...
// EDITED LEEROY
  function hideSearch() {
    ...
    // Reset the button
    $("#searchopener").show();
    // Return focus to the body so keyboard navigation can work
...
// EDITED LEEROY
 ...
 //      //embedded base64 search icon Designed by Sketchdock - http://www.sketchdock.com/:
  ...
  //     dom.wrapper.appendChild( searchElement );
	...
	// Open the search when the 's' [keyCode === 83] key is hit (yes, this conflicts with the notes plugin, disabling for now)
	...
	return { open: openSearch, hide: hideSearch };
})();
